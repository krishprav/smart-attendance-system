      ...
      {isFirstTime ? (
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-extrabold text-blue-900 mb-2 drop-shadow">Welcome to the Smart Attendance System</h1>
            <p className="text-gray-600 text-lg">Let's set up your face recognition for seamless attendance marking</p>
          </div>
          
          <div className="bg-white rounded-2xl shadow-2xl border border-blue-400 p-10 mb-8">
            <h2 className="text-2xl font-bold text-blue-900 mb-4">Face Registration</h2>
        ...
        <>
          <h1 className="text-3xl font-extrabold text-blue-900 mb-6">Face Registration</h1>
          
          <div className="bg-white rounded-2xl shadow-xl border border-blue-200 p-8 mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-4">Why Register Your Face?</h2>
